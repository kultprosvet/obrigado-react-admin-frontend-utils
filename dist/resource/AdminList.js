...
exports.AdminList = (props) => (React.createElement(react_admin_1.List, Object.assign({}, props, { filter: { graphql_fields: "id,username,last_name,first_name" }, filters: React.createElement(AdminsFilter, null), exporter: false }),

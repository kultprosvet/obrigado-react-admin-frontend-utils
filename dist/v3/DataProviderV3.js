...
class DataProviderV3 {
    ...
    getList(resourceName, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (params.filter &&
                ...
                fieldList = __1.gqlGetFieldList(resourceName, this.introspection);
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let query = graphql_tag_1.default `
                    query ${methodName}($id:String!) {
                        ${methodName}(id:$id){
                        ${__1.gqlGetFieldList(resourceName, this.introspection)}
                    }
                    }
                `;
    ...
    update(resourceName, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let inputDataTypeName = introspectionUtils_1.getDataParamName(`admin${resourceName}Update`, this.introspection);
    ...
    updateMany(resourceName, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let inputDataTypeName = introspectionUtils_1.getDataParamName(`admin${resourceName}UpdateMany`, this.introspection);
            let data = params.data;
            yield upload_file_decorator_1.iterateDataAndReplaceFiles(data);
            let query = graphql_tag_1.default `
    ...
    create(resourceName, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let inputDataTypeName = introspectionUtils_1.getDataParamName(`admin${resourceName}Create`, this.introspection);
            let data = params.data;
            yield upload_file_decorator_1.iterateDataAndReplaceFiles(data);
            let query = graphql_tag_1.default `
